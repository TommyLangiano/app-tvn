-- Migration: Fix riepilogo_economico_commessa view
-- Description: Rimuove riferimenti alla tabella scontrini eliminata
-- Date: 2025-02-20

-- Drop the existing view
DROP VIEW IF EXISTS public.riepilogo_economico_commessa;

-- Recreate without scontrini references
...
-- Add comment
COMMENT ON VIEW public.riepilogo_economico_commessa IS 'View che aggrega i dati economici per commessa (ricavi da fatture attive, costi da fatture passive)';
