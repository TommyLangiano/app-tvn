...
if (isProduction && !hasRedisConfig) {
  throw new Error('🚨 CRITICAL: Redis must be configured in production for rate limiting. Set UPSTASH_REDIS_REST_URL and UPSTASH_REDIS_REST_TOKEN in Vercel Environment Variables');
}
