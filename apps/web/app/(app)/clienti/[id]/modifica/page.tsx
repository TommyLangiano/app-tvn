...
import { SettoreCombobox } from '@/components/features/settori/SettoreCombobox';
  ...
  const loadClienteData = async () => {
    try {
      ...
      if (cliente) {
        ...
        setFormaGiuridica(cliente.forma_giuridica);
        setTipologiaSettore(cliente.tipologia_settore || '');
        setNome(cliente.nome || '');
        setCognome(cliente.cognome || '');
        setRagioneSociale(cliente.ragione_sociale || '');
        setFormaGiuridicaDettaglio(cliente.forma_giuridica_dettaglio || '');
        setCodiceFiscale(cliente.codice_fiscale || '');
        setPartitaIva(cliente.partita_iva || '');
        setAteco(cliente.ateco || '');
        setRea(cliente.rea || '');
        setTelefono(cliente.telefono || '');
        setFax(cliente.fax || '');
        setPec(cliente.pec || '');
        setEmail(cliente.email || '');
        setWebsite(cliente.website || '');
        setSedeLegaleVia(cliente.sede_legale_via || '');
        setSedeLegaleCivico(cliente.sede_legale_civico || '');
        setSedeLegaleCap(cliente.sede_legale_cap || '');
        setSedeLegaleCitta(cliente.sede_legale_citta || '');
        setSedeLegaleProvincia(cliente.sede_legale_provincia || '');
        setSedeLegaleNazione(cliente.sede_legale_nazione || 'Italia');
        setSedeOperativaDiversa(cliente.sede_operativa_diversa || false);
        setSedeOperativaVia(cliente.sede_operativa_via || '');
        setSedeOperativaCivico(cliente.sede_operativa_civico || '');
        setSedeOperativaCap(cliente.sede_operativa_cap || '');
        setSedeOperativaCitta(cliente.sede_operativa_citta || '');
        setSedeOperativaProvincia(cliente.sede_operativa_provincia || '');
        setSedeOperativaNazione(cliente.sede_operativa_nazione || 'Italia');
        setModalitaPagamento(cliente.modalita_pagamento_preferita || '');
        setIban(cliente.iban || '');
        setAliquotaIva(cliente.aliquota_iva_predefinita?.toString() || '');
    ...
    <div className="space-y-6">
      <form onSubmit={handleSubmit} className="space-y-8">
            ...
            {formaGiuridica === 'persona_giuridica' && (
              <>
                <div className="space-y-2 md:col-span-2">
                  ...
                  <Input
                    id="ragione_sociale" placeholder="Acme S.r.l."
        ...
        <div className="rounded-lg border border-border bg-card p-6 space-y-4">
          <div className="flex items-center gap-3">
            <div className="w-1 h-6 bg-blue-600 rounded-full" />
            <h3 className="text-lg font-bold">Identificativi Fiscali</h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <Input
                id="codice_fiscale" placeholder="RSSMRA80A01H501U"
                value={codiceFiscale}
            ...
            <div className="space-y-2">
              ...
              <Input
                id="partita_iva" placeholder="12345678901"
                value={partitaIva}
        ...
        <div className="rounded-lg border border-border bg-card p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <Input
                id="telefono" placeholder="+39 081 1234567"
                type="tel"
                value={telefono}
            ...
            <div className="space-y-2">
              ...
              <Input
                id="fax" placeholder="+39 081 7654321"
                value={fax}
            ...
            <div className="space-y-2">
              ...
              <Input
                id="email" placeholder="info@esempio.it"
                type="email"
                value={email}
            ...
            <div className="space-y-2">
              ...
              <Input
                id="pec" placeholder="pec@esempio.it"
                type="email"
                value={pec}
        ...
        <div className="rounded-lg border border-border bg-card p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <Input
                id="sede_legale_via" placeholder="Via Roma"
                value={sedeLegaleVia}
            ...
            <div className="space-y-2">
              ...
              <Input
                id="sede_legale_civico" placeholder="123"
            ...
            <div className="space-y-2">
              ...
              <Input
                id="sede_legale_cap" placeholder="80100"
                value={sedeLegaleCap}
            ...
            <div className="space-y-2">
              ...
              <Input
                id="sede_legale_citta" placeholder="Napoli"
            ...
            <div className="space-y-2">
              ...
              <Input
                id="sede_legale_provincia" placeholder="NA"
            ...
            <div className="space-y-2">
              ...
              <Input
                id="sede_legale_nazione" placeholder="Italia"
        ...
        {formaGiuridica === 'persona_giuridica' && (
          <div className="rounded-lg border border-border bg-card p-6 space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-1 h-6 bg-blue-600 rounded-full" />
                <h3 className="text-lg font-bold">Indirizzo Sede Operativa</h3>
              </div>
            ...
            {sedeOperativaDiversa && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input
                    id="sede_operativa_via" placeholder="Via Roma"
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="sede_operativa_civico" placeholder="123"
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="sede_operativa_cap" placeholder="80100"
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="sede_operativa_citta" placeholder="Napoli"
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="sede_operativa_provincia" placeholder="NA"
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="sede_operativa_nazione" placeholder="Italia"
        ...
        <div className="rounded-lg border border-border bg-card p-6 space-y-4">
          <div className="flex items-center gap-3">
            <div className="w-1 h-6 bg-blue-600 rounded-full" />
            <h3 className="text-lg font-bold">Dati Amministrativi</h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                id="codice_sdi" placeholder="ABCDEFG"
                value={codiceSdi}
        ...
        <div className="rounded-lg border border-border bg-card p-6 space-y-4">
          <div className="flex items-center gap-3">
            <div className="w-1 h-6 bg-blue-600 rounded-full" />
            <h3 className="text-lg font-bold">Note e Gestione Interna</h3>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className="border-2 border-border bg-card min-h-[120px]"
